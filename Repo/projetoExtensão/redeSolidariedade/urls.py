...
urlpatterns = [
    path('cadastroDoacao/', views.cadastroDoacao, name='Cadastro de Doações'),
    path('cadastroDoacao/edit/<int:pk>/', views.editarDoacao, name='Editar Doação'),
    ...
    path('detalhesDoacao/<int:pk>/', views.detalhesDoacao.as_view(), name='Detalhes Doação'),
